...
function start_instances()
    ...
    parameter_sets = [
                      ...
                      [UC_16_3, 1e-4, 1e-4, :none, :bundle_level, 0.2],
                      [UC_24_3, 1e-4, 1e-4, :none, :bundle_level, 0.2],
                      [UC_24_4, 1e-4, 1e-4, :none, :bundle_level, 0.2],
                      [UC_36_3, 1e-4, 1e-4, :none, :bundle_level, 0.2],
