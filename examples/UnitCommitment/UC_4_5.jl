...
function unitCommitment_with_parameters(;
    ...
    plaPrecision::Vector{Float64} = [[0.238], [0.226], [0.204], [0.564], [0.646]], # apart from one generator always 1/5 of pmax
    ...
    NCNBD.solve(model, algoParameters, initialAlgoParameters, appliedSolvers,
                ...
                log_file = "C:/Users/cg4102/Documents/julia_logs/UC_4_5_f.log")
