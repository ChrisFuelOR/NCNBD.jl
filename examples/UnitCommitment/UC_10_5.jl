...
"""
Unit commitment problem with 10 stages and 5 generators, including valve-point effect
"""
...
function unitCommitment_with_parameters(;
    ...
    plaPrecision::Array{Array{Float64,1},1} = [[2.0], [2.0], [2.0], [2.0], [2.0]], # apart from one generator always 1/5 of pmax
    ...
    NCNBD.solve(model, algoParameters, initialAlgoParameters, appliedSolvers,
                ...
                log_file = "C:/Users/cg4102/Documents/julia_logs/UC_10_5_v.log")
