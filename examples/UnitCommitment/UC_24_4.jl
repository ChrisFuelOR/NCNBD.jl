...
function unitCommitment_with_parameters(;
    ...
    NCNBD.solve(model, algoParameters, initialAlgoParameters, appliedSolvers,
                ...
                log_file = "C:/Users/cg4102/Documents/julia_logs/UC_24_4_v_e.log")
...
function define_24_4()
    ...
    demand = 1.15 * [3.66 3.46 3.2 3.18 3.23 3.46 4.09 4.93 5.72 5.96 6.0 6.04 6.02 5.51 5.67 5.72 5.69 5.55 5.34 5.4 5.59 5.28 4.92 4.4]
